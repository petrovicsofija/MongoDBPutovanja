...
{
    public partial class FormSveEkskurzije : Form
    {
        PictureBox[] pbName;
        Button[] butns;
        Label[] labels;

        public FormSveEkskurzije()
        {
            InitializeComponent();
            Init();
        }
        public void Init()
        {
            ...
            var collectionEkskurzije = database.GetCollection<Ekskurzija>("putovanja");

            var query1 = from putovanje in collectionEkskurzije.AsQueryable<Ekskurzija>()
                         where putovanje.TipPutovanja == "Ekskurzija"
                         select putovanje;
            ...
            int i = 0;
            foreach (Ekskurzija l in query1)
            {
        ...
        private void butns_Click(object sender, EventArgs e)
        {
            ...
            FormEkskurzija ekskurzijaForm = new FormEkskurzija(butns[i].Name);
            ekskurzijaForm.Show();
        }

        private void FormSveEkskurzije_Load(object sender, EventArgs e)
        {
