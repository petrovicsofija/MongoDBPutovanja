...
{
    public partial class FormSviSpa : Form
    {
        ...
        private void Init()
        {
            ...
            var collectionWelnessSpa = database.GetCollection<Spa>("putovanja");

            var query1 = from putovanje in collectionWelnessSpa.AsQueryable<Spa>()
        ...
        private void butns_Click(object sender, EventArgs e)
        {
            ...
            FormSpa spaForm = new FormSpa(butns[i].Name);
            spaForm.Show();
        }
