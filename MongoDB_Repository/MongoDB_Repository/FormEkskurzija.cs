...
{
    public partial class FormEkskurzija : Form
    {
        PictureBox[] pbName;
        Button[] butns;
        Label[] labels;
        ...
        public FormEkskurzija(string id)
        {
            InitializeComponent();
        ...
        public void Init()
        {
            ...
            foreach (Ekskurzija l in collectionEkskurzije.Find(Query.EQ("_id", ObjectId.Parse(idLetovanja))))
            {
        ...
        {
            FormKomentar frk = new FormKomentar(idLetovanja, 3);
            frk.Show();
        }
    }
}
